...
export default function TermsAndConditions() {
  ...
  return (
    ...
    Need a little inspiration? You've come to the right place! Explore new flavors, ingredients and recipes that are just waiting to be discovered. Register now and get started.`}
        ...
        url={"https://www.vandemishthan.co.in/terms_and_conditions"}
        tags={" food,food and drink,food industry"}
      />
      <Container className="innerPage lh-lg">
        <div className="sctionHeading text-white">
          <h2>Terms &amp; Conditions</h2>
        </div>
        <Row className="text-white px-2">
          <Col>
            <div className="tucupampam">
              <h4 className="mb-4 mt-5">Updated at 2022-11-19</h4>
              <br />
              <h4 lassName="mb-4 mt-5">General Terms</h4>
              <p className="p8">
                <span className="s1">
                  By accessing and placing an order with {/* <b></b> */}, you
                  ...
                  or other type of communication between you and {/* <b></b> */}
                  . <br />
                  <br /> Under no circumstances shall {/* <b></b> */} team be
                  liable for any direct, indirect, special, incidental or
                  consequential damages, including, but not limited to, loss of
                  data or profit, arising out of the use, or the inability to
                  use, the materials on this site, even if {/* <b></b> */} team
                  ...
                  <br />
                  <br />
                  {/* <b></b> */} will not be responsible for any outcome that
              ...
              <h4 lassName="mb-4 mt-5">License</h4>
              <p className="p10">
                <span className="s1">
                  <b>Vande Mishthan</b> grants you a revocable, non-exclusive,
                  non- transferable, limited license to download, install and
                  use our service strictly in accordance with the terms of this
                  Agreement. <br />
                  <br /> These Terms &amp; Conditions are a contract between you
                  and <b>Vande Mishthan</b> (referred to in these Terms &amp;
                  Conditions as " <b>Vande Mishthan</b>", "us", "we" or "our"),
                  the provider of the <b>Vande Mishthan</b> website and the
                  services accessible from the <b>Vande Mishthan</b> website
                  (which are collectively referred to in these Terms &amp;
                  Conditions as the " <b>Vande Mishthan</b> Service"). <br />
                  <br /> You are agreeing to be bound by these Terms &amp;
                  Conditions. If you do not agree to these Terms &amp;
                  Conditions, please do not use the Service. In these Terms
                  &amp; Conditions, "you" refers both to you as an individual
                  and to the entity you represent. If you violate any of these
              ...
              <h4 lassName="mb-4 mt-5">Definitions and key terms</h4>
              <p className="p8">
              ...
              <ul className="ul1">
                ...
                <li className="li8">
                  <span className="s1">
                    ...
                    <b>Vande Mishthan</b> that is responsible for your
                    information under this Privacy Policy. <br />
                  </span>
                </li>
                <li className="li8">
                  <span className="s1">
                    <strong>Country:</strong> where <b>Vande Mishthan</b> or the
                    owners/founders of <b>Vande Mishthan</b> are based, in this
                    case is <b>India</b>. <br />
                  </span>
                </li>
                <li className="li8">
                  <span className="s1">
                    ...
                    <b>Vande Mishthan</b> Service to manage the relationships
                    with your consumers or service users. <br />
                  </span>
                </li>
                <li className="li8">
                  <span className="s1">
                    ...
                    used to visit <b>Vande Mishthan</b> and use the services.{" "}
                    <br />
                  </span>
                </li>
                <li className="li8">
                ...
                <li className="li8">
                  <span className="s1">
                    ...
                    are employed by <b>Vande Mishthan</b> or are under contract
                    to perform a service on behalf of one of the parties. <br />
                  </span>
                </li>
                <li className="li8">
                  <span className="s1">
                ...
                <li className="li8">
                  <span className="s1">
                    ...
                    <b>Vande Mishthan</b> as described in the relative terms (if
                ...
                <li className="li8">
                  <span className="s1">
                    ...
                    <b>Vande Mishthan</b>’s site, which can be accessed via this
                    URL: <b>www.vandemishthan.co.in.</b>
                    <br />
                  </span>
                </li>
                <li className="li8">
                  <span className="s1">
                    ...
                    with <b>Vande Mishthan</b> to use the Services. <br />
                  </span>
                </li>
              </ul>
              <p className="p9">
              ...
              <h4 lassName="mb-4 mt-5">Restrictions</h4>
              <p className="p10">
                <span className="s1">
              ...
              <h4 lassName="mb-4 mt-5">Return and Refund Policy</h4>
              <p className="p10">
                <span className="s1">
                  ...
                  evaluating, and purchasing our products. <br /> As with any
                  shopping experience, there are terms and conditions that apply
                  to transactions at our company. We’ll be as brief as our
                  attorneys will allow. The main thing to remember is that by
                  placing an order or making a purchase from us, you agree to
                  the terms along with our Privacy Policy. <br /> If, for any
                  reason, You are not completely satisfied with any good or
              ...
              <h4 lassName="mb-4 mt-5">Your Suggestions</h4>
              <p className="p10">
                <span className="s1">
              ...
              <h4 lassName="mb-4 mt-5">Your Consent</h4>
              <p className="p10">
                <span className="s1">
              ...
              <h4 lassName="mb-4 mt-5">Links to Other Websites</h4>
              <p className="p10">
                <span className="s1">
              ...
              <h4 lassName="mb-4 mt-5">Cookies</h4>
              <p className="p10">
                <span className="s1">
              ...
              <h4 lassName="mb-4 mt-5">Modifications to Our service</h4>
              <p className="p10">
                <span className="s1">
              ...
              <h4 lassName="mb-4 mt-5">Updates to Our service</h4>
              <p className="p10">
                <span className="s1">
              ...
              <h4 lassName="mb-4 mt-5">Third-Party Services</h4>
              <p className="p10">
                <span className="s1">
              ...
              <h4 lassName="mb-4 mt-5">Term and Termination</h4>
              <p className="p10">
                <span className="s1">
              ...
              <h4 lassName="mb-4 mt-5">Indemnification</h4>
              <p className="p10">
                <span className="s1">
              ...
              <h4 lassName="mb-4 mt-5">No Warranties</h4>
              <p className="p10">
                <span className="s1">
                  ...
                  corrected. <br />
                  <br /> Without limiting the foregoing, neither us nor any
              ...
              <h4 lassName="mb-4 mt-5">Limitation of Liability</h4>
              <p className="p10">
                <span className="s1">
              ...
              <h4 lassName="mb-4 mt-5">Severability</h4>
              <p className="p10">
                <span className="s1">
                  ...
                  <br /> This Agreement, together with the Privacy Policy and
              ...
              <h4 lassName="mb-4 mt-5">Waiver</h4>
              <p className="p10">
                <span className="s1">
                  ...
                  breach. <br />
                  <br /> No failure to exercise, and no delay in exercising, on
              ...
              <h4 lassName="mb-4 mt-5">Amendments to this Agreement</h4>
              <p className="p10">
                <span className="s1">
              ...
              <h4 lassName="mb-4 mt-5">Entire Agreement</h4>
              <p className="p10">
                <span className="s1">
              ...
              <h4 lassName="mb-4 mt-5">Updates to Our Terms</h4>
              <p className="p10">
                <span className="s1">
              ...
              <h4 lassName="mb-4 mt-5">Intellectual Property</h4>
              <p className="p10">
                <span className="s1">
              ...
              <h4 lassName="mb-4 mt-5">Agreement to Arbitrate</h4>
              <p className="p10">
                <span className="s1">
              ...
              <h4 lassName="mb-4 mt-5">Notice of Dispute</h4>
              <p className="p10">
                <span className="s1">
              ...
              <h4 lassName="mb-4 mt-5">Binding Arbitration</h4>
              <p className="p10">
                <span className="s1">
              ...
              <h4 lassName="mb-4 mt-5">Submissions and Privacy</h4>
              <p className="p10">
                <span className="s1">
              ...
              <h4 lassName="mb-4 mt-5">Promotions</h4>
              <p className="p10">
                <span className="s1">
              ...
              <h4 lassName="mb-4 mt-5">Typographical Errors</h4>
              <p className="p10">
                <span className="s1">
              ...
              <h4 lassName="mb-4 mt-5">Miscellaneous</h4>
              <p className="p10">
                <span className="s1">
              ...
              <h4 lassName="mb-4 mt-5">Disclaimer</h4>
              <p className="p10">
                <span className="s1">
              ...
              <h4 lassName="mb-4 mt-5">Contact Us</h4>
              <p className="p10">
                <span className="s1">
              ...
              <ul className="ul1">
                <li className="li16">
                  <span className="s3">
                    Via Email: <b>lthakur92411@gmail.com</b>
                  </span>
                </li>
              </ul>
            </div>
