...
Order Now and get at your Home.`}
        ...
        url={"https://www.vandemishthan.co.in/privacy-policy"}
      ...
      <Form>
        <Row className="px-2 text-white">
          <Col md={12}>
            <h4 className="mb-4 mt-5">Updated at 2022-07-23</h4>
            <p>
              VandeMishthan. ("we," "our," or "us") is committed to protecting
              your privacy. This Privacy Policy explains how your personal
              information is collected, used, and disclosed by VandeMishthan.
            </p>
            <p>
              This Privacy Policy applies to our website,{" "}
              <a href="https://www.vandemishthan.co.in" className="text-white">
                https://www.vandemishthan.co.in
              </a>
            ...
            <h4 className="mb-4 mt-5">Definitions and key terms</h4>
            <h5>For this Privacy Policy:</h5>
            <ol>
              <li>
              ...
              <li>
                ...
                or “our,” it refers to VandeMishthan that is responsible for
                your information under this Privacy Policy.
              </li>
              <li>
                <b>Country:</b> where VandeMishthan or the owners/founders of
                VandeMishthan are based, in this case is India.
              </li>
              <li>
                <b>Customer:</b> refers to the company, organization or person
                that signs up to use the VandeMishthan Service to manage the
              ...
              <li>
                ...
                VandeMishthan and use the services.
              </li>
              <li>
              ...
              <li>
                ...
                by VandeMishthan or are under contract to perform a service on
              ...
              <li>
                <b>Service:</b> refers to the service provided by VandeMishthan
              ...
              <li>
                <b>Website:</b> VandeMishthan’s site, which can be accessed via
                this URL:{" "}
                <a
                  href="https://www.vandemishthan.co.in"
              ...
              <li>
                ...
                VandeMishthan to use the Services.
              </li>
            </ol>
            <h4 className="mb-4 mt-5">Information automatically collected</h4>
            <p>
            ...
            <p>
              ...
              security and operation of our , and for our internal analytics and
              reporting purposes.
            </p>
            ...
            <h4 className="mb-4 mt-5">Sale of Business</h4>
            <p>
            ...
            <h4 className="mb-4 mt-5">Affiliates</h4>
            <p>
            ...
            <h4 className="mb-4 mt-5">How Long Do We Keep Your Information?</h4>
            <p>
            ...
            <h4 className="mb-4 mt-5">How Do We Protect Your Information?</h4>
            <p>
            ...
            <h4 className="mb-4 mt-5">Governing Law</h4>
            <p>
            ...
            <h4 className="mb-4 mt-5">Cookies</h4>
            <p>
            ...
            <h4 className="mb-4 mt-5">Advertising</h4>
            <p>
            ...
            <h4 className="mb-4 mt-5">Cookies for Advertising</h4>
            <p>
            ...
            <h4 className="mb-4 mt-5">Kids' Privacy</h4>
            <p>
            ...
            <h4 className="mb-4 mt-5">Changes To Our Privacy Policy</h4>
            <p>
            ...
            <h4 className="mb-4 mt-5">Third-Party Services</h4>
            <p>
            ...
            <h4 className="mb-4 mt-5">Facebook Pixel</h4>
            <p>
            ...
            <h4 className="mb-4 mt-5">What is GDPR?</h4>
            <p>
            ...
            <h4 className="mb-4 mt-5">What is personal data?</h4>
            <p>
            ...
            <h4 className="mb-4 mt-5">Why is GDPR important?</h4>
            <p>
            ...
            <h4 className="mb-4 mt-5">California Residents</h4>
            <p>
